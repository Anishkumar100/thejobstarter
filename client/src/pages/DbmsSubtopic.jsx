...
/*
 * DbmsSubtopic — displays a single DBMS subtopic with explanation,
 * embedded video, downloadable resources, and a link to practice problems.
 */
export default function DbmsSubtopic() {
  const { lessonSlug, subtopicSlug } = useParams();
  const { currentSubtopic, subtopicsLoading, subtopicsError, fetchSubtopicBySlug } = useDbmsStore();
  ...
  return (
    <div className="subtopic-page">
      <Helmet>
        <title>{title} — DBMS — TheJobStarter</title>
        <meta name="description" content={description || ''} />
      </Helmet>

      {/* ═════ BACK LINK ═════ */}
      <div className="subtopic-back-bar">
        <Link to={`/dbms/${lessonSlug}`} className="subtopic-back-link">
      ...
      >
        ...
        <aside className="subtopic-sidebar">
          ...
          <Link to={`/dbms/${lessonSlug}/${subtopicSlug}/problems`} className="subtopic-sidebar__cta">
