/*
 * Seed Control Flow lesson content into MongoDB
 * Uses slug-based upserts — never deletes existing data.
 * Run: node programming-content/seed_control-flow.mjs
 * NOTE: Generated from programming-content/next.md — do not hand-edit; regenerate via generate_seed.mjs next.md after updating next.md.
 */
...
async function main() {
  ...
  const subtopics = [
{
      slug: "conditional-statements", lessonSlug: "control-flow", order: 0,
...
{
      slug: "loops", lessonSlug: "control-flow", order: 1,
      title: "Loops",
...
{
      slug: "loop-control", lessonSlug: "control-flow", order: 2,
      title: "Loop Control",
  ...
  const problems = [
{
      slug: "sum-of-digits", lessonSlug: "control-flow", subtopicSlug: "loops",
      ...
      examples: [{"input":"n = 123","output":"6","explanation":"1 + 2 + 3 = 6."},{"input":"n = 4567","output":"22","explanation":"4 + 5 + 6 + 7 = 22."},{"input":"n = 9","output":"9","explanation":"A single digit — its sum is itself."},{"input":"n = 0","output":"0","explanation":"Zero has no digits to add."}],
      constraints: ["n is a non-negative integer up to 10^9.","Do not convert the number to a string.","Use loops and arithmetic only."],
      ...
      codeBlocks: [{"language":"python","code":"def sum_of_digits(n):\n    total = 0\n    while n > 0:\n        digit = n % 10          # last digit\n        total += digit\n        n //= 10                # drop last digit\n    return total\n\nprint(sum_of_digits(123))   # 6\nprint(sum_of_digits(4567))  # 22"},{"language":"javascript","code":"function sumOfDigits(n) {\n    let total = 0;\n    while (n > 0) {\n        total += n % 10;            // add last digit\n        n = Math.floor(n / 10);     // drop last digit\n    }\n    return total;\n}\n\nconsole.log(sumOfDigits(123));   // 6\nconsole.log(sumOfDigits(4567));  // 22"},{"language":"java","code":"public static int sumOfDigits(int n) {\n    int total = 0;\n    while (n > 0) {\n        total += n % 10;        // add last digit\n        n = n / 10;             // drop last digit\n    }\n    return total;\n}\n// sumOfDigits(123)  == 6\n// sumOfDigits(4567) == 22"}],
      timeComplexity: "O(d)", spaceComplexity: "O(1)",
      youtubeUrl: "", pdfUrl: "", pptxUrl: "", media: []
    },
{
      slug: "fizzbuzz", lessonSlug: "control-flow", subtopicSlug: "loop-control",
      ...
      examples: [{"input":"n = 5","output":"[\"1\", \"2\", \"Fizz\", \"4\", \"Buzz\"]","explanation":"3 is a multiple of 3; 5 is a multiple of 5."},{"input":"n = 15","output":"[\"1\",\"2\",\"Fizz\",\"4\",\"Buzz\",\"Fizz\",\"7\",\"8\",\"Fizz\",\"Buzz\",\"11\",\"Fizz\",\"13\",\"14\",\"FizzBuzz\"]","explanation":"15 is a multiple of both 3 and 5, so it becomes FizzBuzz."},{"input":"n = 3","output":"[\"1\", \"2\", \"Fizz\"]","explanation":"3 is the first multiple of 3."},{"input":"n = 1","output":"[\"1\"]","explanation":"1 is not a multiple of 3 or 5."}],
      constraints: ["n is a positive integer up to 100.","Return the result as a list of strings (or print line by line)."],
      ...
      codeBlocks: [{"language":"python","code":"def fizz_buzz(n):\n    result = []\n    for i in range(1, n + 1):\n        if i % 15 == 0:            # divisible by 3 AND 5\n            result.append(\"FizzBuzz\")\n        elif i % 3 == 0:\n            result.append(\"Fizz\")\n        elif i % 5 == 0:\n            result.append(\"Buzz\")\n        else:\n            result.append(str(i))\n    return result\n\nprint(fizz_buzz(15))"},{"language":"javascript","code":"function fizzBuzz(n) {\n    const result = [];\n    for (let i = 1; i <= n; i++) {\n        if (i % 15 === 0) result.push(\"FizzBuzz\");\n        else if (i % 3 === 0) result.push(\"Fizz\");\n        else if (i % 5 === 0) result.push(\"Buzz\");\n        else result.push(String(i));\n    }\n    return result;\n}\n\nconsole.log(fizzBuzz(15));"},{"language":"java","code":"public static List<String> fizzBuzz(int n) {\n    List<String> result = new ArrayList<>();\n    for (int i = 1; i <= n; i++) {\n        if (i % 15 == 0) result.add(\"FizzBuzz\");\n        else if (i % 3 == 0) result.add(\"Fizz\");\n        else if (i % 5 == 0) result.add(\"Buzz\");\n        else result.add(String.valueOf(i));\n    }\n    return result;\n}"}],
...
{
      slug: "sum-of-digits",
      questions: [{"text":"Which operator extracts the last digit of a number?","options":["% (modulo)","/ (division)","* (multiplication)","- (subtraction)"],"correctIndex":0},{"text":"What does integer division by 10 do to a number?","options":["Adds a 0 at the end","Removes the last digit","Doubles the number","Nothing"],"correctIndex":1},{"text":"What is the sum of the digits of 4567?","options":["20","21","22","23"],"correctIndex":2},{"text":"When should the loop stop in sum of digits?","options":["After 3 iterations","When the total reaches 10","When the number becomes 0","Never"],"correctIndex":2},{"text":"What is the time complexity of sum of digits?","options":["O(n)","O(log n)","O(n^2)","O(1)"],"correctIndex":1}]
    },
{
      slug: "fizzbuzz",
      questions: [{"text":"What should print for the number 15?","options":["Fizz","Buzz","FizzBuzz","15"],"correctIndex":2},{"text":"Why must the \"both\" case be checked first?","options":["Because it is the rarest case","Because 15 is divisible by 3, so it would wrongly print Fizz","Because the loop is faster that way","It does not matter"],"correctIndex":1},{"text":"What does i % 15 == 0 check?","options":["Divisible by 3 only","Divisible by 5 only","Divisible by both 3 and 5","Divisible by 15 only when i is even"],"correctIndex":2},{"text":"For n = 5, what is the correct output?","options":["1, 2, Fizz, 4, Buzz","1, 2, 3, 4, 5","Fizz, Buzz, Fizz, Buzz, FizzBuzz","1, 2, Fizz, Buzz, Fizz"],"correctIndex":0},{"text":"What is the time complexity of FizzBuzz?","options":["O(1)","O(n)","O(n^2)","O(log n)"],"correctIndex":1}]
    }
  ];
  ...
  /* ─── Done ─── */
  console.log('\n[SEED] Control Flow lesson seeded successfully!');
  console.log('  Lesson:    1 (Control Flow)');
