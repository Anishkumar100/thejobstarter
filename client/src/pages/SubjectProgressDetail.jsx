...
export default function SubjectProgressDetail() {
  ...
  const validSubjects = ['dsa', 'dbms', 'os', 'programming', 'aptitude'];
  const subjectLabel = { dsa: 'DSA', dbms: 'DBMS', os: 'OS', programming: 'Programming', aptitude: 'Aptitude' }[subject] || subject;
  const subjectColors = {
    ...
    aptitude: { bg: '#fff7ed', accent: '#f97316', border: '#ea580c' }
  };
