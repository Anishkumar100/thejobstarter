...
export default function DsaDetail() {
  ...
  const { currentProblem, currentLesson, problemsLoading, problemsError, fetchProblemBySlug } = useDsaStore();
  ...
  const backLink = lessonSlug && subtopicSlug
    ? `/dsa/${lessonSlug}/${subtopicSlug}/problems`
    : lessonSlug
      ? `/dsa/${lessonSlug}`
      : '/dsa';
    ...
    return (
      <div className="container" style={{ paddingTop: 'var(--space-xl)', paddingBottom: 'var(--space-2xl)' }}>
        ...
        <div className="paywall-banner">
          ...
          <Link to={lessonSlug ? `/dsa/${lessonSlug}` : '/dsa'} className="paywall-banner__back">
            ← Back to {lessonSlug ? 'Lesson' : 'DSA'}
          </Link>
        </div>
      </div>
    );
  ...
  return (
    <div className="pdetail-page">
      <Helmet>
        <title>{p.title} — DSA — TheJobStarter</title>
      ...
      >
        ...
        <aside className="pdetail-codeside">
          ...
          <div className="pdetail-codeside-downloads">
            ...
            {lessonSlug && (
              <Link to={`/dsa/${lessonSlug}`} className="pdetail-sidebar-link">
