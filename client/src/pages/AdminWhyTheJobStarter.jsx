...
const DEFAULT_DATA = {
  ...
  pillars: [
    ...
    { title: 'One Architecture,\nFive Subjects', body: 'DSA, DBMS, OS, Programming, and Aptitude were designed together, sharing the same structure. GeeksforGeeks, LeetCode, and HackerRank each grew around one subject and never rebuilt around a shared model \u2014 their DBMS/OS content, where it exists, doesn\u2019t even navigate like their DSA content does.' },
    ...
    { title: 'Aptitude &\nReasoning, Live Now', body: "DSA, DBMS, OS, and Programming were just the start. Aptitude and reasoning \u2014 the fifth pillar of campus placement prep \u2014 is live now, built on the exact same Lessons \u2192 Subtopics \u2192 Problems structure as everything else here." }
  ],
  comparison: [
