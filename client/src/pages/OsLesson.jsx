...
/*
 * OsLesson — displays a single OS lesson and its subtopics.
...
export default function OsLesson() {
  ...
  if (!currentLesson && !lessonsLoading && !subtopicsLoading) {
    return (
      <div className="container" style={{ paddingTop: 'var(--space-xl)' }}>
        <Link to="/os" className="detail-back"><ArrowLeft01Icon size={16} /> Back to OS</Link>
  ...
  return (
    <div>
      <Helmet>
        <title>{currentLesson?.title || 'Lesson'} — OS — TheJobStarter</title>
      ...
      <section className="dsa-hero">
        ...
        <div className="container dsa-hero__content">
          ...
          >
            <ArrowLeft01Icon size={16} /> Back to OS
          </Link>
