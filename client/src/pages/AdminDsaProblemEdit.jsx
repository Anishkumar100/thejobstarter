          ...
          {examples.map((ex, i) => (
            <div key={i} className="admin-form__example-row">
              <div className="admin-form__example-io">
                <textarea className="input textarea--lg" rows={8} placeholder="Input (markdown tables supported)" value={ex.input} onChange={e => handleExample(i, 'input', e.target.value)} />
                <textarea className="input textarea--lg" rows={8} placeholder="Output (markdown tables supported)" value={ex.output} onChange={e => handleExample(i, 'output', e.target.value)} />
              </div>
